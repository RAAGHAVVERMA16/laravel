...
<head>
    ...
    <!-- <link rel="stylesheet" href="{{ asset('assets/css/fontawesome/fontawesome.min.css') }}"> -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.2.1/css/fontawesome.min.css" integrity="sha384-QYIZto+st3yW+o8+5OHfT6S482Zsvz2WfOzpFSXMF9zqeLcFV0/wlZpMtyFcZALm" crossorigin="anonymous">
    <script src="https://code.jquery.com/jquery-3.7.1.min.js" integrity="sha256-/JqT3SQfawRcv/BIHPThkBvs0OEvtFFmqPF/lYI/Cxo=" crossorigin="anonymous"></script>
...
<script
 ...
 <!-- <link rel="stylesheet" 
  ...
  <link rel="stylesheet"
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/dataTables/dataTables.bootstrap.min.js') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/dataTables/jquery.dataTables.min.js') }}"> -->
</head>
<body>
